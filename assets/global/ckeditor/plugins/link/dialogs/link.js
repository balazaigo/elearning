                        ...
                        },
                        {
                            ...
                            onChange: function () {
                                var a = this.getDialog(),
                                    ...
                                    f = f && f.hidden;
                                "url" == r ? (c.config.linkShowTargetTab && a.showPage("target"), f || a.showPage("upload")) : (a.hidePage("target"), f || a.hidePage("upload"));
                            ...
                            children: [
                                {
                                    ...
                                    children: [
                                        ...
                                        },
                                        {
                                            type: "hbox",
                                            children: [
                                                { type: "text", widths: ["50%", "50%"], labelLayout: "horizontal", label: h.width, id: "width", setup: d, commit: e },
                                                { type: "text", labelLayout: "horizontal", widths: ["50%", "50%"], label: b.popupLeft, id: "left", setup: d, commit: e },
                                            ],
                                        },
                                        {
                                            type: "hbox",
                                            children: [
                                                { type: "text", labelLayout: "horizontal", widths: ["50%", "50%"], label: h.height, id: "height", setup: d, commit: e },
                            ...
                            children: [
                                {
                                    ...
                                    children: [
                                        ...
                                        { type: "text", id: "advAccessKey", requiredContent: "a[accesskey]", width: "80px", label: b.acccessKey, maxLength: 1, setup: g, commit: k },
                                    ],
                                },
                                {
                                    type: "hbox",
                                    ...
                                    children: [
                                        ...
                                        { type: "text", label: b.langCode, id: "advLangCode", requiredContent: "a[lang]", width: "110px", default: "", setup: g, commit: k },
                                        { type: "text", label: b.tabIndex, id: "advTabIndex", requiredContent: "a[tabindex]", width: "80px", maxLength: 5, setup: g, commit: k },
                                    ],
                                },
                            ],
                        },
                            ...
                            children: [
                                {
                                    ...
                                    widths: ["45%", "55%"],
                                    children: [
                                        { type: "text", label: b.advisoryTitle, requiredContent: "a[title]", default: "", id: "advTitle", setup: g, commit: k },
                                        { type: "text", label: b.advisoryContentType, requiredContent: "a[type]", default: "", id: "advContentType", setup: g, commit: k },
                                    ],
                                },
                                {
                                    type: "hbox",
                                    widths: ["45%", "55%"],
                                    children: [
                                        { type: "text", label: b.cssClasses, requiredContent: "a(cke-xyz)", default: "", id: "advCSSClasses", setup: g, commit: k },
                                        { type: "text", label: b.charset, requiredContent: "a[charset]", default: "", id: "advCharset", setup: g, commit: k },
                                    ],
                                },
                                {
                                    type: "hbox",
                                    widths: ["45%", "55%"],
                                    children: [
                                        { type: "text", label: b.rel, requiredContent: "a[rel]", default: "", id: "advRel", setup: g, commit: k },
                                        { type: "text", label: b.styles, requiredContent: "a{cke-xyz}", default: "", id: "advStyles", validate: CKEDITOR.dialog.validate.inlineStyle(c.lang.common.invalidInlineStyle), setup: g, commit: k },
                                    ],
                                },
                                {
                                    type: "hbox",
            ...
            onOk: function () {
                ...
                if (this._.selectedElements.length) {
                    ...
                    for (g = 0; g < h.length; g++) {
                        d = h[g];
                        d.collapsed
                            ? ((e = new CKEDITOR.dom.text(a.linkText || ("email" == a.type ? a.email.address : b.set["data-cke-saved-href"]), c.document)), d.insertNode(e), d.selectNodeContents(e))
                            : q !== a.linkText && ((e = new CKEDITOR.dom.text(a.linkText, c.document)), d.shrink(CKEDITOR.SHRINK_TEXT), c.editable().extractHtmlFromRange(d), d.insertNode(e));
                        e = d._find("a");
