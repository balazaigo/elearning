(function($){
    ...
    var methods = {
        ...
        /**
         * Ð”Ð¾Ð±Ð°Ð²Ð»ÐµÐ½Ð¸Ðµ Ð½Ð¾Ð²Ð¾Ð³Ð¾ Ñ„Ð°Ð¹Ð»Ð° Ð² Ð¾Ñ‡ÐµÑ€ÐµÐ´ÑŒ Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÐ¸
         * @param inputID
         * @param file
         */
        ...
        /**
         * Ð—Ð°Ð³Ñ€ÑƒÐ·ÐºÐ° Ñ„Ð°Ð¹Ð»Ð° Ð¸Ð»Ð¸ Ð²ÑÐµÑ… Ñ„Ð°Ð¹Ð»Ð¾Ð²
         * @param inputID
         * @param file_number
         */
        ...
        /**
         * Ð£Ð´Ð°Ð»ÐµÐ½Ð¸Ðµ Ñ„Ð°Ð¹Ð»Ð° Ð¸Ð»Ð¸ Ð²ÑÐµÑ… Ñ„Ð°Ð¹Ð»Ð¾Ð²
         * @param inputID
         * @param file_number
         */
        ...
        /**
         * Ð£Ð´Ð°Ð»ÐµÐ½Ð¸Ðµ Ð²ÑÐµÑ… ÑÐ¾Ð±Ñ‹Ñ‚Ð¸Ð¹
         * @param inputID
         * @param name
         */
    ...
    $.fileup = function(param1, param2, param3) {
        ...
        // Ð’Ñ‹Ð¿Ð¾Ð»Ð½ÐµÐ½Ð¸Ðµ Ð¼ÐµÑ‚Ð¾Ð´Ð°
        ...
        // ÐŸÐ¾Ð»ÑƒÑ‡ÐµÐ½Ð¸Ðµ ÑÐ¿Ð¸ÑÐºÐ° ÑÐ¾Ð±Ñ‹Ñ‚Ð¸Ð¹ Ð´Ð»Ñ Ð´Ð¾Ð±Ð°Ð²Ð»ÐµÐ½Ð¸Ñ ÑÐ²Ð¾ÐµÐ³Ð¾
        } else if ( typeof param1 === 'string' &&
